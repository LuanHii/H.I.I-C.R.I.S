...
export const AgentSelectorModal: React.FC<AgentSelectorModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
      <div className="bg-zinc-950 border border-zinc-800 rounded-xl w-full max-w-2xl flex flex-col max-h-[80vh] shadow-2xl animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="flex items-center justify-between p-4 border-b border-zinc-800 bg-zinc-900/50 rounded-t-xl">
          <div>
            ...
            <p className="text-sm text-zinc-500 font-mono">Selecione os agentes que participarão desta sessão.</p>
          </div>
          <button 
            onClick={onClose}
              ...
              return (
                <button
                  ...
                  className={`
                    ...
                    ${isActive 
                      ? 'bg-zinc-900/80 border-ordem-red/50 shadow-[0_0_15px_rgba(220,38,38,0.1)]' 
                ...
                >
                  ...
                  <div className="flex-1">
                    <h4 className={`font-bold ${isActive ? 'text-zinc-100' : 'text-zinc-400'}`}>
                      {personagem.nome}
                    </h4>
        ...
        <div className="p-4 border-t border-zinc-800 bg-zinc-900/30 rounded-b-xl flex justify-end">
          <button 
            onClick={onClose}
            className="px-6 py-2 bg-zinc-100 hover:bg-white text-zinc-950 font-bold rounded transition-colors"
          >
            Concluir
          </button>
        </div>
